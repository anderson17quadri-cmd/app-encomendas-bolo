...
import { View, Text, StyleSheet, FlatList, Pressable, Platform, SafeAreaView } from 'react-native';
  ...
  const handleDayPress = useCallback(async (day: DateData) => {
    ...
    if (date) {
      try {
        ...
        console.error('Error loading day orders:', e);
        setDayOrders([]);
      }
    }
  }, [getOrdersByDate]);
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.headerTitle}>🎂 Encomendas de Bolo</Text>
      </View>
