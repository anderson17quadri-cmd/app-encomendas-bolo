...
export default function NovaEncomendaScreen() {
  ...
  const [form, setForm] = useState<OrderFormData>({
    clientName: '',
    deliveryDate: typeof date === 'string' && date ? date : '',
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      // Copy image to app documents on native
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Pressable onPress={handleSave} disabled={saving} hitSlop={12} accessibilityLabel="Salvar encomenda">
        ...
        <ScrollView contentContainerStyle={styles.formContainer} keyboardShouldPersistTaps="handled">
          ...
          <View style={styles.channelRow}>
            {CHANNELS.map((ch) => {
              ...
              return (
                ...
                >
                  <Ionicons
                    name={ch === 'WhatsApp' ? 'logo-whatsapp' : 'logo-instagram'}
                    size={18}
                    color={isActive ? Colors.white : chColor}
                  />
                  <Text style={[
          ...
          >
            ...
            <Text style={[styles.selectText, { marginLeft: 8 }]}>
              {formatDateDisplay(form?.deliveryDate)}
            </Text>
          </Pressable>
          ...
          <Pressable
            ...
            onPress={handleSave}
            disabled={saving}
            accessibilityLabel="Salvar encomenda"
            accessibilityRole="button"
          >
